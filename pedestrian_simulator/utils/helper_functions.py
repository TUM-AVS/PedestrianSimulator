...
def plot_vector(ax, point, vector, color, **kwargs):
    """
    ...
    **kwargs: Additional keyword arguments to pass to ax.plot.
    ...
    ax.arrow(point[0], point[1], vector[0], vector[1],
             head_width=0.1, head_length=0.2, fc=color, ec=color, **kwargs)
    # ax.plot(point[0], point[1], 'ro',  **kwargs)  # Mark the starting point
